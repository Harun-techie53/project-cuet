...
const ContactScreen = () => {
  return (
    <section className="py-6 bg-gray-800 text-gray-50 lg:pb-72 h-screen flex flex-col justify-between">
		...
		<div className="py-6 md:py-0 md:px-6">
			...
			<div className="space-y-4">
				<p className="flex items-center">
					...
					<span>Chittagong University of Engineering and Technology (CUET)

Chittagong - 4349, Bangladesh</span>
				</p>
				<p className="flex items-center">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-2 sm:mr-6">
						<path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"></path>
					</svg>
					<span>+880-31-714946, +880-31-714911</span>
				</p>
				<p className="flex items-center">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-2 sm:mr-6">
					...
					<span>registrar@cuet.ac.bd, iict@cuet.ac.bd</span>
				</p>
			</div>
		</div>
